...
<section id="menu" class="section" style="padding-top: 300px; padding-bottom: 120px;"> 
	<div class="section_container">
		...
		<div align="center">
			<table style="line-height: 2; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; margin: 20px 10px; width: 80%; text-align: center;">
				<colgroup>
					<col style="width:120px"><col style="width:auto"><col style="width:250px"><col style="width:100px">
				</colgroup>
				
				<thead style="    font-weight: bold;vertical-align: top; color: #fff;background: #e7708d;margin: 20px 10px;">
					<tr>
				...
				<tbody>
					...
					<tr class="_hover_tr">
						<td style="background: #fdf3f5;">${vs.count }</td>
